...
[Python API guide](../forterp/05-targets-dialects.md#the-two-axes-target-and-dialect) for the dialect switches, targets,
and tunable knobs, and [Command-line tools](../forterp/02-cli.md) for the command line.
